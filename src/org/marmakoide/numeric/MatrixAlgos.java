...
public final class MatrixAlgos {
  ...
  /*Symmetric tridiagonal QL algorithm, iterative Computes the eigensystem from
   * a tridiagonal matrix in roughtly 3N^3 operations */
  ...
  public final static void Householder(final Matrix outM, final Vector outD,
      final Vector outE) {
    final int N = outM.getCols();
