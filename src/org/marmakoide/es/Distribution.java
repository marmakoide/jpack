...
/**
 * Represents a probability distribution of samples points.
 * 
 * A Distribution is owned by a Strategy instance. A Distribution plays 2
 * roles:
 * <ul>
 * <li>Generating candidates points according to a probability distribution</li>
...
public interface Distribution {
  ...
  /**
   * Initialize the distribution, called at each time its associated Strategy
   * starts
   * 
   * @param inStrategy
  ...
  /**
   * Update the distribution, called each time its associated Strategy updates
   * 
   * @param inStrategy
   *          Strategy which owns the Distribution
   */
